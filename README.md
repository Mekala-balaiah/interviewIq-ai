...
[![Sprint Progress](https://img.shields.io/badge/Sprint-17%20of%2020-blue?style=flat-square)](https://github.com/Mekala-balaiah/interviewiq-ai/blob/main/docs/SPRINT_TRACKER.md)
[![Version](https://img.shields.io/badge/Version-0.17.0-green?style=flat-square)](https://github.com/Mekala-balaiah/interviewiq-ai/releases)
...
```
█████████████████░░░  Sprint 17 of 20 (85% complete)
```

| Sprint | Module | Status | Version |
|--------|--------|--------|---------|
| ✅ 1–16| Initial Setup to Elasticsearch | Done | [v0.16.0](https://github.com/Mekala-balaiah/interviewiq-ai/releases/tag/v0.16.0) |
| ✅ 17 | Testing Suite | Done | [v0.17.0](https://github.com/Mekala-balaiah/interviewiq-ai/releases/tag/v0.17.0) |
| 🔄 18 | Deployment (Docker + CI/CD) | **Active** | v0.18.0 |
| ⬜ 19–20 | Remaining Modules | Planned | — |
